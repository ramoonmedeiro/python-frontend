...
# Seu código SVG transformado em ReactPy
...
def NavBar():
    return html.header(
        html.div(
            {"class": "flex fixed bg-black text-white w-full px-3 h-20 py-4"},
            html.div(
            ...
            html.div(
                {"class": "flex justify-end flex-1 text-white text-3xl hidden"},
                html.i(
                    {"class": "fas fa-bars"}
                )
            ),
            html.div(
                {"class": "flex items-end flex-1 text-white font-bold"},
                html.nav(
                    {"class": "flex-1"},
                    html.ul(
                        {"class": "flex justify-end flex-1"},
                        html.li(
                            {"class": "font-[Poppins,sans-serif] px-4"},
                            html.a(
                                {
                                    "href": "#",
                                    "class": "hover:text-[#18D760] text-sm"
                                },
                                "Premium"
                            )
                        ),
